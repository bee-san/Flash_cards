...
my_dict =   {
                ...
                "turn a decimal into a fraction?" : "Write the decimal number over 1 - EG 2.5 becomes 2.5/1\nTimes the top number by 10 and do the same to the bottom number keep timsing by 10 until both numbers are integers. Simplfy if nessacery.",
                "Name of the first ever computer?" : "Colusus",
                "The brain of the computer is?" : "CPU",
                "Way to remeber Mean, Average etc?" : "Hey diddle diddle, the medium is the middle. we add and divide for the mean. the mode is the one you see the most. and the range is the difference inbetween",
...
while playing == True:
    ...
    for i in range(num):
        ...
        if guess.lower() == answer.lower():
            ...
            guess = input(str("Did you get this?"))
